// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CertificateQualityLiteFilterStrategy.cs" company="VZ">
...
namespace Buisness.Components.Strategies.CertificateQualityDomain.ManufacturersCertificateDomain
{
    ...
    /// The certificate quality filter strategy.
    /// </summary>
    [FilterForEntity(typeof(CertificateQualityLiteDto))]
    public class CertificateQualityLiteFilterStrategy : FilteringStrategyBase<CertificateQualityLiteDto, CertificateQualityFilter>
    {
        /// <summary>
        /// The filtering.
        /// </summary>
        ...
        /// </returns>
        public override IQueryOver<CertificateQualityLiteDto, CertificateQualityLiteDto> Filtering(
            IQueryOver<CertificateQualityLiteDto, CertificateQualityLiteDto> query, CertificateQualityFilter filter)
        {
            ...
            {
                query.Where(x => x.RnCreator == filter.UserCreator.Rn);
            }
