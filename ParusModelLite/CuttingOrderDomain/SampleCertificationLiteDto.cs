// --------------------------------------------------------------------------------------------------------------------
// <copyright company="VZ" file="SampleCertificationLiteDto.cs">
...
namespace ParusModelLite.CuttingOrderDomain
{
    ...
    /// <summary>
    /// There are no comments for ParusModelLite.CuttingOrderDomain.SampleCertificationLiteDto, ParusModelLite in the schema.
    /// </summary>
    public partial class SampleCertificationLiteDto : INotifyPropertyChanging, INotifyPropertyChanged, IDto<long>
    {
        ...
        {
            SampleCertificationLiteDto toCompare = obj as SampleCertificationLiteDto;
            if (toCompare == null)
            {
                return false;
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleCertificationLiteDto"/> class. 
        /// There are no comments for SampleCertificationLiteDto constructor in the schema.
        /// </summary>
        public SampleCertificationLiteDto()
        {
            this.OnCreated();
        }
