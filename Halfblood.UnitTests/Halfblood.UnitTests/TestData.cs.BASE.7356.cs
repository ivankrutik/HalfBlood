        ...
        public static void Create(ISession session)
        {
            ...
            var actsInputControlTechnicalState = Builder<ActInputControlTechnicalState>.CreateListOfSize(10)
                .All()
                    .With(x => x.RN = 0)
                    .With(x => x.Company = new Company { RN = 7830001 })
                    //.Do(x => x.TechnicalStateEssentials.Add(Pick<TechnicalStateEssential>.UniqueRandomList(With.Between(1, 10).Elements).From(technicalStatesEssential)[0]))
                .Build();
            ...
            var conclusions = Builder<Conclusion>.CreateListOfSize(10)
                .All()
                    ...
                    .With(x => x.Company = new Company { RN = 7830001 })
                    .With(x => x.Agnlist = SampleEntity.GetUserMaratoss())
                    //.Do(x => x.ConclusionEssentials.Add(Pick<ConclusionEssential>.UniqueRandomList(With.Exactly(1).Elements).From(conclusionsEssential)[0]))
                .Build();
            ...
            var qualityStatesControlOfTheMake = Builder<QualityStateControlOfTheMake>.CreateListOfSize(10)
                .All()
                    ...
                    .With(x => x.Company = new Company { RN = 7830001 })
                    .With(x => x.Agnlist = SampleEntity.GetUserMaratoss())
                    //.With(x => x.QualityStateControlOfTheMakeSignatureS = qualityStatesControlOfTheMakeSignature)
                    //.Do(x => x.QualityStateControlOfTheMakeSignatureS.Add(Pick<QualityStateControlOfTheMakeSignature>.UniqueRandomList(With.Between(1, 10).Elements).From(qualityStatesControlOfTheMakeSignature)[0]))
                .Build();
